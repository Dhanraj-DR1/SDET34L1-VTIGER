...
public class CreateContactWithCopyOtherAdressTest extends BaseClass{
	@Test(groups="sanity")
	public void createContactWithCopyOtherAdress() throws InterruptedException {
		...
		createContactPage.enterAddressAndcopyOtherAddressRdBtnClick(street,postBox,city,state,postalcode,country);
